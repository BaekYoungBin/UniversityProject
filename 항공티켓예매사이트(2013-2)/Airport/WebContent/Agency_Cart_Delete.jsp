...
<% 
	...
	try{
		...
		ResultSet rs = stmt.executeQuery("select Plane_Type from Agency_Cart where A_id ='" + ID +"'");
		int i = 0;
		while (rs.next()){
			Plane_Type[i] = rs.getString("Plane_Type");			
			i++;
		}	
		rs = stmt.executeQuery("delete from Agency_Cart where PLANE_TYPE = '"+Plane_Type[sel]+"'");
