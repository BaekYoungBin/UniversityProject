...
<%@ page import="java.io.*"%>
	...
	%><form action="Agency_Cart_continue.jsp" method="POST" >
	...
	try{
		...
		ResultSet rs = stmt.executeQuery("select A_ID, Plane_type, Origin, Destination, Cost from Agency_cart where A_id = '"+ID+"'");
		int i = 0;
		while (rs.next()){		
