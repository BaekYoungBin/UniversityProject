...
<% 
	...
	try{
		...
		ResultSet rs = stmt.executeQuery("select Plane_Type from Agency_Reservation where A_id ='" + ID +"'");
		int i = 0;
		while (rs.next()){
		...
		rs = stmt.executeQuery("delete from Agency_Reservation where PLANE_TYPE = '"+Plane_Type[sel]+"'");
